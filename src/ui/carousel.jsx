...
/**
 * Context to share carousel controls/content
 */
 ...
 * - setApi: function(api) -> called when Embla instance is ready
 */
const Carousel = React.forwardRef(function Carousel(
  ...
  React.useEffect(() => {
    if (api && typeof setApi === "function") setApi(api)
  }, [api, setApi])
...
/**
 * <CarouselContent>
 * Wrap the slides row; provides overflow container + track positioning.
 */
...
/**
 * <CarouselItem>
 * A single slide item; uses padding to create gutter.
 */
...
export {
  ...
  CarouselPrevious,
  CarouselNext,
  // Optional: expose the hook if you want custom controls
  useCarousel,
}
